...
contract SupplyChain is FarmerRole, ConsumerRole, DistributorRole, RetailerRole, Ownable {
  ...
  onlyFarmer
  {
    ...
    items[_upc] = Item({
      ...
      originFarmerID : _originFarmerID, originFarmName : _originFarmName, originFarmInformation : _originFarmInformation,
      originFarmLatitude : _originFarmLatitude, originFarmLongitude : _originFarmLongitude, productID : _upc + sku,
